...
faqs:
  - q: "What's the single biggest reason a med spa doesn't show up in AI search results?"
    a: "Usually it's a lack of authoritative mentions. If no trusted third-party sources — review platforms, local publications, industry directories — are citing your business by name, AI models simply don't have enough evidence to confidently recommend you."
  - q: "Does Google ranking affect whether AI assistants mention my med spa?"
    a: "Indirectly, yes. AI models pull from a wide web crawl, and content that ranks well on Google tends to get indexed and cited more often. But AI recommendations aren't purely a ranking game — a business with modest SEO but lots of high-quality mentions across diverse sources can still surface in AI responses."
  - q: "How many reviews do I need before AI tools start recommending me?"
    a: "There's no magic number, but patterns suggest that practices with 50 or more recent, detailed reviews across Google, Yelp, and RealSelf carry noticeably stronger signals. Quality matters as much as quantity — specific reviews that name treatments and outcomes give AI models richer data to work with."
  - q: "Will updating my website content actually change how AI tools talk about my med spa?"
    a: "Yes, over time. When you publish structured, answer-first content that directly addresses questions patients are asking, that content becomes citable. AI models are trained on and retrieve web content, so clear, factual, specific pages stand a much better chance of being quoted or referenced than vague marketing copy."
  - q: "How long does it take to start appearing in AI recommendations?"
    a: "Most practices see movement within 60 to 90 days of consistently building citations, improving on-page content, and growing their review profile. GEO isn't instant, but it compounds — each new mention or review adds to a body of evidence AI tools can draw on."
---
...
We wrote a full breakdown of [how reviews drive visibility](/blog/patient-reviews-and-visibility) if you want the deeper picture. The quick takeaway: build a systematic follow-up process that asks patients for reviews within 24 to 48 hours of their appointment, while the experience is fresh.

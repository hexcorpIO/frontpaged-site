...
export const wellness: Vertical = {
  ...
  compliance: {
    regime: "medical",
    summary:
      "Wellness and longevity marketing sits under FTC truth-in-advertising rules, and device, drug, and supplement claims are further constrained by their FDA-cleared indications. We write to those limits and route final copy through your medical director.",
    weWillNot: [
      "Promise a specific clinical outcome, lifespan extension, or biological-age result",
      "Claim a device, drug, or supplement does something outside its cleared indications",
